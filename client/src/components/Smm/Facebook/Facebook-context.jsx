...
import { facebookContextTextActionCreator } from './../../../redux/Smm-reducer'
...
const FacebookContext = (props) => {
    ...
    let onTextChange = () => {
        ...
        props.dispatch(facebookContextTextActionCreator({ link: linkText, city: cityText, good: goodText, content: contentText }));
    ...
    return (
        <div>
            ...
            <Helmet>
                <title>Facebook контекстная реклама - ChaseBox</title>
                <meta name="Context Facebook"
                    content="Context Facebook" />
            </Helmet>
        </div>
    );
}
