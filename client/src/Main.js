...
import { nameActionCreator, showSidebarActionCreator } from './redux/Header-reducer'
        ...
        <React.Fragment>
          <div>
            ...
            <div className="app-wrapper">
              ...
              <IconButton aria-label="" className={s.openSidebar} onClick={closeSidebar}>
                <MenuIcon />
              </IconButton>
              <Drawer anchor="left" open={props.state.header.header.showSidebar} className={s.sideMenu} onClose={closeSidebar}>
                {/* <Scrollbars autoHeightMax={100} className="mobile_bar"> */}
                <div className={s.responsive} style={{ backgroundColor: "#1f122c", height: '100%', width: 281 }}>
