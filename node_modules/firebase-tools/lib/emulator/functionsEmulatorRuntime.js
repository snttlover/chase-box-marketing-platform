...
function initializeRuntime(frb, serializedFunctionTrigger) {
    return __awaiter(this, void 0, void 0, function* () {
...
function handleMessage(message) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (!triggers) {
            ...
            triggers = yield initializeRuntime(runtimeArgs.frb, serializedTriggers);
        }
        if (!triggers) {
            yield flushAndExit(1);
            return;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        process.on("message", (message) => {
            messageHandlePromise = messageHandlePromise
                ...
                new types_1.EmulatorLog("FATAL", "runtime-error", err).log();
